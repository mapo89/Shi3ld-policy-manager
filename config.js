settings = {
	...
	RDFInterface: "sparql",
	policyNamedGraphURI: "file://policies.rdf.xml",
	SPARQLEndPoint: "fuseki",//"sesame",
	SPARQLEndPointInfo: {
		host: "localhost",
	    port: "3030",//"8080",
		dataset: "books",//"berlin-test",
		testDataset: "ds",//"test-policies",
	 ...
	 *
	 * defaultPrefix: is the default namespace used by the client if no others specified in a policy;
	 * defaultBase: is the default base URL if no others specified in a policy;
	 * accessConditionType: specifies the way access condition are expressed. Use "sparql" for
	 *						express them as SPARQL ASK query (only value allowed).
     **/
     
	defaultPrefix: "http://example.org/shi3ld/",
	defaultBase: "http://example.org/shi3ld/",
	 ...
	 * shi3ld framework.
	 *
	 * shi3ldURI: URI where is possible to submit requests to shi3ld.
	 * 
     **/
